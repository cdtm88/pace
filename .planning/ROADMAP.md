...
**Wave 1**
  ...
  - [x] 02-01-PLAN.md — Profile schema migration (+unique userId) + Coggan zones utility + Zod profileSchema + query helper + Wave 0 test scaffolds

**Wave 2** *(blocked on Wave 1)*

  - [x] 02-02-PLAN.md — saveProfileAction + copy.ts + shadcn textarea/progress + 3-step onboarding wizard + (onboarding) page + (app) onboarding gate
